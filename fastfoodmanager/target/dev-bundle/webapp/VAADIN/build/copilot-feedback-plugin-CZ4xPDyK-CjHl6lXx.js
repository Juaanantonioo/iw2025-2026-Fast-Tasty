import { p as pe, g, y as y$1, a as se, w as wt, t as te, R as Re, M as Mu, D as Dl } from "./indexhtml-LDSXBVBe.js";
import { b as b$1 } from "./state-Kz-UOm6S-CrTAfSXv.js";
import { u, h } from "./overlay-monkeypatch-SLP1K3NP-khr9LXOQ.js";
import { i as i$1 } from "./base-panel-Dr4zQ6S6-Bwe4Uwq8.js";
import { o as o$1 } from "./icons-hMCj4mhz-BMEZ31js.js";
...
let i = class extends i$1 {
    ...
    return this.message === void 0 ? pe`
          <div class="dialog-footer">
            <button
              ...
              @click="${() => {
      g.active ? y$1.emit("system-info-with-callback", {
  ...
  submit() {
    ...
    g.active ? y$1.emit("system-info-with-callback", {
      callback: (t) => te(`${Re}feedback`, { ...e, versions: t }),
      notify: false
    }) : te(`${Re}feedback`, { ...e, versions: {} }), this.parentNode?.style.setProperty("--section-height", "150px"), this.message = "Thank you for sharing feedback.";
  }
  keyDown(e) {
